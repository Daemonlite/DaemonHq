        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <MenuItem>
                <Typography textAlign="center" onClick={()=> navigate('/reviews')}>Companies</Typography>
                </MenuItem>
                <MenuItem>
                <Typography textAlign="center" onClick={()=> navigate('/salaries')}>Salaries</Typography>
                </MenuItem>
                <MenuItem>
                <Typography textAlign="center" onClick={()=> navigate('/stocks')}>Stock Market</Typography>
                </MenuItem>
